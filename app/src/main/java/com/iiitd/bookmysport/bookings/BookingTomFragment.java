...
public class BookingTomFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.bookingfragmenttomlayout, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.FragRecyclerViewTom);
        adaptor = new FragRecyclerViewAdaptor(getContext(), time_data, 2);
